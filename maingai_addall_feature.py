...
import time
from util_addall_feature import GB_load_data, separate_data
...
def main():
    ...
    parser.add_argument('--filename', type = str, default = "",
                                        help='output file')
    parser.add_argument('--coarsening_method', type = str, default = "origin",
                                        help='coarsening_method')
    parser.add_argument('--coarsening_ratio', type = float, default = 0.2,
                                        help='coarsening_ratio')   
    parser.add_argument('--purity', type = float, default = 0,
                                        help='purity level:1. 0 NO Purity 2. 2 Purity adaptive 3. 3 Purity plus structural adaptation 4. 0-1 Purity setting')
    parser.add_argument('--degree_purity', type = str, default = 'False',
                                        help='True: Use structure splitting first, then purity splitting')
